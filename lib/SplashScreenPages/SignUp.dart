          ...
          children: <Widget>[
            Container(
                ...
                child: Row(children: <Widget>[
                  Text(
                    AppLocalizations.of(context).translate('su_title'),
                    style: TextStyle(
                        color: ColorTheme.c1,
            ...
            Container(
                ...
                child: Wrap(
                    children: <Widget>[
                  Text(
                    AppLocalizations.of(context).translate('su_subtitle'),
                    style: TextStyle(
                ...
                child: Material(
                  ...
                  child: TextField(
                    decoration: InputDecoration(
                      hintText: AppLocalizations.of(context).translate('su_name'),
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                color: ColorTheme.c1,
                child: Text(
                  AppLocalizations.of(context).translate('su_button'),
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: FontData.p2,
                  ),
            ...
            Container(
                ...
                child:GestureDetector(
                  child: Text(
                    AppLocalizations.of(context).translate('su_lg_button'),
                    style: TextStyle(
                      color: ColorTheme.c1,
