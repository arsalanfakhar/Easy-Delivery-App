...
class SearchPickUp extends SearchDelegate<String> {
  final cities = ['Karachi', 'Lahore', 'Islamabad', 'Multan', 'Rawalpindi'];

  final suggestedCities = ['Multan', 'Quetta'];
